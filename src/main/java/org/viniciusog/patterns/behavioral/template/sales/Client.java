package org.viniciusog.patterns.behavioral.template.sales;

import org.viniciusog.patterns.behavioral.template.sales.model.Buyer;
...
import org.viniciusog.patterns.behavioral.template.sales.model.Product;
import org.viniciusog.patterns.behavioral.template.sales.service.BestOfferService;
...
public class Client {
    ...
    public static void main(String[] args) {
        Buyer simpleBuyer1 = new Buyer("Buyer Simple #1", 1500, false);
        Buyer simpleBuyer2 = new Buyer("Buyer Simple #2", 3000, false);
        Buyer specialBuyer = new Buyer("Buyer Special #1", 500, true);
        Buyer specialBuyer2 = new Buyer("Buyer Special #2", 3000, true);
